...
public class Ardennes extends Robot {
    ...
    private OdometrySystemImpl makeOdometrySystem(){
        Odometer x1 = FTCUtilities.getOdometer("intakeL", 2.3596,true); //*** IMPORTANT *** setDirection() method on DcMotor changes encoder direction
        Odometer x2 = FTCUtilities.getOdometer("intakeR", 2.3617, true);
        Odometer y = FTCUtilities.getOdometer("BR", 2.387, true);

        OdometrySystemImpl odometrySystem = new OdometrySystemImpl(x1, x2, y, 0.11348, 14.5);
