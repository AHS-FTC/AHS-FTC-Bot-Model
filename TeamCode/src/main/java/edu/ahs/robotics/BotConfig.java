...
public class BotConfig {
    ...
    private MotorHashService.MotorTypes driveMotorType;
    private double wheelDiameter;
    private GearRatio driveGearRatio = new GearRatio();
    //private int[] driveGears = new int[]{1, 1}; //input, output
    private boolean wasDriveGearRatioInitialized = false;
    private HashMap<MotorLocations, String> driveMotorDeviceNames;
    private HashMap<MotorLocations, Boolean> flippedMotors;
    ...
    public boolean isFullyConfigured() {
        ...
        if (!wasDriveGearRatioInitialized) {
            throw new Warning("The Drive Gear Ratio was never configured using BotConfig. DriveUnits will assume a 1:1 ratio.");
        }
