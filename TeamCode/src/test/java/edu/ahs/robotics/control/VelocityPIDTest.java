...
public class VelocityPIDTest {
    ...
    public void testProportionality(){
        ...
        init(config);
        Velocity velocity = new Velocity(1, 1);
        Velocity wrongVelocity = new Velocity(2, 2);
        Velocity wrongerVelocity = new Velocity(10,10);
    ...
    public void testAllZeroCoefficients(){
        ...
        init(config);
        Velocity velocity = new Velocity(1, 1);
        Velocity veryWrongVelocity = new Velocity(100,100);
    ...
    public void testDerivative(){
        ...
        Velocity velocity = new Velocity(1, 1);
        Velocity farVelocity = new Velocity(10, 10);
        Velocity closeVelocity = new Velocity(1.1, 1.1);
